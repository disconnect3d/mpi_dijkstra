/* Taurus WFiIS - Lab. 206/207 (13/04/2016):

   Bug w gdb: aby nie wyświetlał komunikatu o braku tego pliku,
   należy go skopiować do katalogu bieżącego, przed uruchomieniem
   gdb. Albo zainstalować pakiet eglibc-source:
   plik znajduje się w archiwum usr/src/glibc/eglibc-2.??.tar.xz
*/
